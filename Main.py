...
# read the dictionary
doc = open(r'C:\Users\Hafsa_Waheed\Desktop\MY PROJECTS\AI-Scrabble-Solver-main\scrabbleDictionary.txt', 'r')
...
def run(width=1000, height=600):
    ...
    x.refreshSpecialTiles(EV.tripleWord, EV.doubleWord, EV.doubleLetter, EV.tripleLetter) # special tiles in dataStorage
